...
import { Shield, TrendingUp, AlertCircle, Users, Activity } from "lucide-react"
      ...
      <div className="space-y-3.5">
        <div>
          <div className="flex justify-between text-[10px] font-sans font-bold text-[#D7B05C] mb-1">
            <span className="flex items-center gap-1"><TrendingUp size={12} /> Overall Completion</span>
        ...
        <div className="grid grid-cols-2 gap-2 pt-2 border-t border-[#4A2C1D]/60 text-xs font-sans">
          <div className="p-2 bg-[#15100C] border border-[#4A2C1D] rounded-xs">
            <span className="flex items-center gap-1 text-[9px] font-bold text-[#D7B05C]/70 uppercase">
              <AlertCircle size={10} className="text-rose-400" /> Overdue Objectives
            </span>
            <p className="text-sm font-serif font-black text-rose-400 mt-0.5">{overdueTasksCount}</p>
          </div>
          ...
          <div className="p-2 bg-[#15100C] border border-[#4A2C1D] rounded-xs">
            ...
            <p className="text-sm font-serif font-black text-sky-300 mt-0.5">Balanced</p>
          </div>

          <div className="p-2 bg-[#15100C] border border-[#4A2C1D] rounded-xs">
            <span className="flex items-center gap-1 text-[9px] font-bold text-[#D7B05C]/70 uppercase">
              <Activity size={10} className="text-emerald-400" /> Weekly Velocity
            </span>
            <p className="text-sm font-serif font-black text-emerald-400 mt-0.5">▲ +12%</p>
          </div>
          ...
          <div className="p-2 bg-[#15100C] border border-[#4A2C1D] rounded-xs">
            ...
            <p className="text-sm font-serif font-black text-[#F8EEDB] mt-0.5">{overdueRate}%</p>
          </div>
        </div>
      </div>
    </DashboardSection>
