...
const features = [
  ...
  },
  {
    ...
    description: "Assemble officers, delegate permissions, and maintain workspace harmony across all realms.",
  },
  {
    icon: Calendar,
  ...
  },
  {
    ...
    description: "Enterprise-grade Clerk authentication and PostgreSQL encryption safeguard your kingdom records.",
  },
  {
    icon: Zap,
    title: "Instant Dispatches",
    description: "Optimized server actions deliver real-time database updates across your entire workspace.",
  },
]

export function Features() {
  return (
    <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#100A07] text-[#F8EEDB] font-serif relative">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-xs sm:text-sm font-sans text-[#D7B05C]/80 max-w-2xl mx-auto italic">
            Powerful medieval operations tools designed to keep projects organized and teams aligned.
          </p>
        </div>
