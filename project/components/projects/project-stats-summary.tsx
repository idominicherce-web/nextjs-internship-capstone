...
import { FolderKanban, ShieldCheck, Clock, Archive } from "lucide-react"
        ...
        return (
          ...
          >
            <div className="flex items-center space-x-3">
              <div className={`p-2 rounded-full border border-[#8F6236]/50 bg-[#15100C] ${card.color}`}>
                <Icon size={18} />
              </div>
              <div>
                ...
                <p className={`text-lg font-black font-serif ${card.color}`}>{card.value}</p>
              </div>
            </div>
          </div>
        )
