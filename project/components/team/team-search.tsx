...
export function TeamSearch({
  ...
  const hasFilters = Boolean(searchQuery || selectedRole !== "all" || selectedStatus !== "all")

  return (
    <div className="flex flex-col sm:flex-row gap-3 items-center">
      {/* Search Input */}
      <div className="relative flex-1 w-full">
        <Search size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#D7B05C]/70" />
        <input
          type="text"
          value={searchQuery}
      ...
      <div className="relative w-full sm:w-44">
        ...
        <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#D7B05C] pointer-events-none" />
      </div>
