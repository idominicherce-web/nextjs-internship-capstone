...
export function DashboardSection({
	...
	return (
		<div
			className={`relative rounded-xs border-4 border-[#3B2415] bg-gradient-to-b from-[#4A2C1D] via-[#2D1B10] to-[#15100C] p-5 sm:p-6 shadow-[0_15px_35px_rgba(0,0,0,0.85)] overflow-hidden ${className}`}
		>
