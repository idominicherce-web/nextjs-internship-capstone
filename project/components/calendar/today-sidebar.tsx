...
const TODAY_SCHEDULE: ScheduleItem[] = [
  { time: "09:00", title: "War Council Strategy", project: "Project Alpha", typeBadge: "Meeting" },
  { time: "11:30", title: "API Integration Audit", project: "Internal Tools", typeBadge: "Deadline" },
  { time: "14:00", title: "Realm UI Review", project: "Project Phoenix", typeBadge: "Review" },
  { time: "16:30", title: "Deployment Milestone", project: "Project Alpha", typeBadge: "Milestone" },
]
  ...
  return (
    <div className="rounded-xs border-2 border-[#8F6236]/80 bg-gradient-to-b from-[#2D1B10] via-[#1A120C] to-[#15100C] p-4 shadow-xl space-y-4">
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-[9.5px] font-sans text-[#D7B05C]/70">{item.project}</p>
              </div>
            </div>
      ...
      <div className="p-2.5 rounded-xs border border-amber-600/40 bg-amber-950/20 text-amber-300 text-[10px] font-sans flex items-start space-x-2">
        ...
        <p>Royal Scribe Note: High-priority deadlines scheduled for tomorrow morning.</p>
      </div>
    </div>
  )
}