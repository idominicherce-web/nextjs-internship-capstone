...
import { Scroll, Clock, CheckCircle, Award } from "lucide-react"
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center space-x-3">
              <div className={`p-2 rounded-full border bg-[#15100C] ${card.borderColor} ${card.color} group-hover:scale-110 transition-transform`}>
                <Icon size={18} />
              </div>
